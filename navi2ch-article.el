...
(unless navi2ch-article-mode-map
  (setq navi2ch-article-mode-map (make-sparse-keymap))
  (define-key navi2ch-article-mode-map "q" 'navi2ch-article-exit)
  (define-key navi2ch-article-mode-map "Q" 'navi2ch-article-goto-current-board)
  (define-key navi2ch-article-mode-map "s" 'navi2ch-article-sync)
  (define-key navi2ch-article-mode-map "S" 'navi2ch-article-sync-disable-diff)
  (define-key navi2ch-article-mode-map "r" 'navi2ch-article-redraw-range)
  (define-key navi2ch-article-mode-map "j" 'navi2ch-article-few-scroll-up)
  (define-key navi2ch-article-mode-map "k" 'navi2ch-article-few-scroll-down)
  (define-key navi2ch-article-mode-map " " 'navi2ch-article-scroll-up)
  (define-key navi2ch-article-mode-map [del] 'navi2ch-article-scroll-down)
  (define-key navi2ch-article-mode-map [backspace] 'navi2ch-article-scroll-down)
  (define-key navi2ch-article-mode-map "\177" 'navi2ch-article-scroll-down)
  (define-key navi2ch-article-mode-map "w" 'navi2ch-article-write-message)
  (define-key navi2ch-article-mode-map "W" 'navi2ch-article-write-sage-message)
  (define-key navi2ch-article-mode-map "t" 'navi2ch-toggle-offline)
  (define-key navi2ch-article-mode-map "\r" 'navi2ch-article-select-current-link)
  (navi2ch-define-mouse-key navi2ch-article-mode-map 2 'navi2ch-article-mouse-select)
  (define-key navi2ch-article-mode-map "g" 'navi2ch-article-goto-number-or-board)
  ;; (define-key navi2ch-article-mode-map "g" 'navi2ch-article-goto-number)
  (define-key navi2ch-article-mode-map "G" 'navi2ch-list-goto-board)
  (define-key navi2ch-article-mode-map "l" 'navi2ch-article-pop-point)
  (define-key navi2ch-article-mode-map "L" 'navi2ch-article-pop-poped-point)
  (define-key navi2ch-article-mode-map "m" 'navi2ch-article-push-point)
  (define-key navi2ch-article-mode-map "U" 'navi2ch-article-show-url)
  
  (define-key navi2ch-article-mode-map "." 'navi2ch-article-redisplay-current-message)
  (define-key navi2ch-article-mode-map "p" 'navi2ch-article-previous-message)
  (define-key navi2ch-article-mode-map "n" 'navi2ch-article-next-message)
  (define-key navi2ch-article-mode-map "P" 'navi2ch-article-through-previous)
  (define-key navi2ch-article-mode-map "N" 'navi2ch-article-through-next)
  (define-key navi2ch-article-mode-map [(shift tab)] 'navi2ch-article-previous-link)
  (define-key navi2ch-article-mode-map "\e\C-i" 'navi2ch-article-previous-link)
  (define-key navi2ch-article-mode-map "\C-\i" 'navi2ch-article-next-link)
  ...
  (define-key navi2ch-article-mode-map "d" 'navi2ch-article-hide-message)
  (define-key navi2ch-article-mode-map "a" 'navi2ch-article-add-important-message)
  (define-key navi2ch-article-mode-map "h" 'navi2ch-article-toggle-hide)
  (define-key navi2ch-article-mode-map "$" 'navi2ch-article-toggle-important)
  (define-key navi2ch-article-mode-map "1" 'navi2ch-one-pain)
  (define-key navi2ch-article-mode-map "2" 'navi2ch-article-two-pain)
  (define-key navi2ch-article-mode-map "3" 'navi2ch-three-pain)
  (define-key navi2ch-article-mode-map "A" 'navi2ch-article-add-global-bookmark)
  (define-key navi2ch-article-mode-map "B" 'navi2ch-bookmark-goto-bookmark)
  (define-key navi2ch-article-mode-map "\C-c\C-f" 'navi2ch-article-find-file)
  (define-key navi2ch-article-mode-map "\C-c\C-u" 'navi2ch-goto-url)
  (define-key navi2ch-article-mode-map "\C-c\C-m" 'navi2ch-message-pop-message-buffer)
  (define-key navi2ch-article-mode-map "\C-xk" 'navi2ch-article-kill-buffer))
...
(defun navi2ch-article-view-article (board article &optional force number max-line)
  "スレを見る。FORCE で強制読み込み
MAX-LINE で読み込む行数を指定。だた `navi2ch-article-max-line' とは逆で t で全部読み込み"
