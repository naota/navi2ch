...
(unless navi2ch-list-mode-map
  (setq navi2ch-list-mode-map (make-sparse-keymap))
  (define-key navi2ch-list-mode-map "\r" 'navi2ch-list-select-current-board)
  (define-key navi2ch-list-mode-map "q" 'navi2ch-exit)
  (define-key navi2ch-list-mode-map "z" 'navi2ch-suspend)
  (define-key navi2ch-list-mode-map "s" 'navi2ch-list-sync)
  (define-key navi2ch-list-mode-map " " 'navi2ch-list-select-current-board)
  (define-key navi2ch-list-mode-map [del] 'scroll-down)
  (define-key navi2ch-list-mode-map [backspace] 'scroll-down)
  (define-key navi2ch-list-mode-map "n" 'next-line)
  (define-key navi2ch-list-mode-map "p" 'previous-line)
  (define-key navi2ch-list-mode-map "a" 'navi2ch-list-add-bookmark)
  (define-key navi2ch-list-mode-map "b" 'navi2ch-list-toggle-bookmark)
  (define-key navi2ch-list-mode-map "t" 'navi2ch-toggle-offline)
  (navi2ch-define-mouse-key navi2ch-list-mode-map 2 'navi2ch-list-mouse-select)
  (define-key navi2ch-list-mode-map "g" 'navi2ch-list-goto-board)
  (define-key navi2ch-list-mode-map "/" 'navi2ch-list-toggle-open)
  (define-key navi2ch-list-mode-map "[" 'navi2ch-list-open-all-category)
  (define-key navi2ch-list-mode-map "]" 'navi2ch-list-close-all-category)
  (define-key navi2ch-list-mode-map ">" 'navi2ch-end-of-buffer)
  (define-key navi2ch-list-mode-map "<" 'beginning-of-buffer)
  (define-key navi2ch-list-mode-map "1" 'navi2ch-one-pain)
  (define-key navi2ch-list-mode-map "2" 'navi2ch-list-two-pain)
  (define-key navi2ch-list-mode-map "3" 'navi2ch-three-pain)
  (define-key navi2ch-list-mode-map "\C-c\C-f" 'navi2ch-article-find-file)
  (define-key navi2ch-list-mode-map "\C-c\C-u" 'navi2ch-goto-url)
  (define-key navi2ch-list-mode-map "D" 'navi2ch-list-delete-global-bookmark)
  (define-key navi2ch-list-mode-map "C" 'navi2ch-list-change-global-bookmark)
  (define-key navi2ch-list-mode-map "B" 'navi2ch-bookmark-goto-bookmark)
  (define-key navi2ch-list-mode-map "?" 'navi2ch-list-search)
  (define-key navi2ch-list-mode-map "e" 'navi2ch-list-expire))
